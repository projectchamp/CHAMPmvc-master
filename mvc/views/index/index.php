<?php //include('http://127.0.0.1/mvc/public/php/conn.php'); ?>
<! doctype html>
<html>
<head>
...
<div class="container">
            <div class="row">
             ...
             <div class="vr pull-left hidden-xs hidden-sm " ></div>
				     <div class="col-md-6">
...
<div class="vr pull-left hidden-xs hidden-sm " ></div>
					   <div class="col-md-2">
							...
							<p class="bg-primary ">News And Events</p>
							
							<marquee  style="text-align:center"	 behavior="scroll" direction="up" scrollamount="6" onmousedown="this.stop();" onmouseup="this.start();">
							<?php include('http://127.0.0.1/mvc/public/php/news.php'); ?>							<br><br><br><br>
...
<?php include('http://127.0.0.1/mvc/public/php/footer.php'); ?>j
<!-- Modal -->
<?php include('http://127.0.0.1/mvc/public/php/modal.php'); ?>
