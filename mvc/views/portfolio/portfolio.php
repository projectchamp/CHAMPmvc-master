...
<script src="http://127.0.0.1/mvc/public/js/textition.js"></script>
<script>
// handler on element
$(function() {
...
<h1>PORTFOLIO</h1>
<hr>
				  <?php include('http://127.0.0.1/mvc/public/php/port.php'); ?>
...
<?php		if(isset($capt)){
                          ...
                          require_once 'http://127.0.0.1/mvc/php/captcha/securimage.php';
                          $options = array();
